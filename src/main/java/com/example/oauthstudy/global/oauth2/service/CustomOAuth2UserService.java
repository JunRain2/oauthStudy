package com.example.oauthstudy.global.oauth2.service;

import com.example.oauthstudy.global.oauth2.CustomOAuth2User;
import com.example.oauthstudy.global.oauth2.OAuthAttributes;
...
public class CustomOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        /**
         * loadUser(userRequest)를 통해 DefaultOAuth2User 객체를 생성한 후 반환
        ...
        String userNameAttributeName = userRequest.getClientRegistration()
                .getProviderDetails().getUserInfoEndpoint().getUserNameAttributeName(); // OAuth2 로그인 시 PK가 되는 값
